...
// //           context.read<UserProvider>().setBalance(freshPoints);
// //         }
// //       } else if (apiResponse == null && mounted) {
// //         // Trigger dialog if API returns null due to connection failure
// //        // showNetworkErrorDialog(context, () => loadUserData());
// //       }
// //     } catch (e) {
// //       debugPrint("Error updating wallet balance: $e");
// //       if (mounted) {
...
// //       loadUserData(); // Reload user state after returning from login
// //     } else {
// //       onAuthenticated();
// //     }
// //   }
...
//         }
//       } else if (apiResponse == null && mounted) {
//         // Handle connection failure when needed
//       }
//     } catch (e) {
//       debugPrint("Error updating wallet balance: $e");
//     } finally {
...
class HomeHeaderState extends State<HomeHeader> {
  ...
  Widget build(BuildContext context) {
    const double halfCardHeight = 48;
final bool hasNotification = context.watch<NotificationProvider>().hasUnread;
    // Set to true or bind with Provider/API status
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  // )
                  InkWell(
  onTap: () => _handleProtectedAction(() async {
    await context.push('/noti');
    // Call your API or update provider when user comes back from notification screen
    if (mounted) {
      // Example: context.read<NotificationProvider>().checkUnreadNotifications();
      // or context.read<NotificationProvider>().markAllAsRead();
    }
  }),
  borderRadius: BorderRadius.circular(20),
  child: Container(
