          ...
          child: Column(
            children: [
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            // 2. Status Badge: Displays Green (Open) or Red (Closed)
                            Container(
                              padding: const EdgeInsets.symmetric(
                                horizontal: 8,
                                vertical: 3,
              ...
              SizedBox(
                ...
                height: 38,
                child: ElevatedButton(
                  // 3. Button is disabled when closed
                  onPressed: isOpen ? () => onTap?.call() : null,
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.white,
                  ...
                  // 4. Button Text changes based on status
                  child: Text(
                    isOpen ? "မီနူးကြည့်ရန်" : "ဆိုင်ပိတ်ထားသည်",
                    style: TextStyle(
                      color: isOpen
                          ? const Color(0xff117992)
                          : Colors.grey.shade600,
