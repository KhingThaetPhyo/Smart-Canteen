...
class _PopularMenuCardState extends State<_PopularMenuCard> {
  ...
  void initState() {
    super.initState();
    _favoritesManager.addListener(_onFavoriteChanged);
  }

  @override
  void dispose() {
    _favoritesManager.removeListener(_onFavoriteChanged);
    super.dispose();
  }
  ...
  @override
  Widget build(BuildContext context) {
    final bool isFavorite = _favoritesManager.isFavorite(widget.menu);
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
  onTap: () {
    // 1. Create a ShopModel using the shopId from the MenuModel
    final shopModel = ShopModel(
      shopId: widget.menu.shopId, // Retrieved directly from MenuModel[cite: 28]
      shopName: widget.shopName,   // Passed down from _DisplayMenuItem
      userId: 0,                   // Default or fallback value
      shopPhone: '',
      isOpen: 1,
      createdAt: '',
      updatedAt: '',
    ...
    // 2. Navigate via GoRouter to the shop detail route
    context.push('/shop_detail/${shopModel.shopId}', extra: shopModel);
  },
  borderRadius: BorderRadius.circular(6),
  child: Container(
    width: 25,
