  ...
  final List<Map<String, String>> onboardingData = [
    {
      ...
      "description":
          "ကျောင်းသားကတ်ပေါ်တွင် ဖော်ပြထားသည့် Roll Number၊ အမည်အပြည့်အစုံ၊ Email နှင့် ဖုန်းနံပါတ်တို့ကို မှန်ကန်စွာထည့်သွင်းပြီး အကောင့်ဖွင့်ပါ။",
      "icon": "person_add",
    },
    {
      "title": "Wallet Pin သတ်မှတ်ပါ",
      "description":
          "အစားအသောက်များကို မှာယူနိုင်ရန် သင့်အကောင့် Wallet Pin သတ်မှတ်ပါ။",
      "icon": "pin",
    },
    {
