      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 6),
            Text(
              "Coffee Corner Canteen • အိုင်ဒီ: CC-8921",
              style: TextStyle(fontSize: 13, color: Colors.grey.shade600),
            ),
            const SizedBox(height: 24),
            SizedBox(
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                        "ငွေပေးချေရန် QR Code ကို လေးထောင့်ကွက်အတွင်း တည်ပေးပါ",
                        style: TextStyle(
                          color: Colors.white.withOpacity(0.85),
                          fontSize: 12,
                          fontWeight: FontWeight.w500,
          ...
          /// TOP BAR WITH CONTROLS (Includes Back Button)
          Positioned(
            top: 50,
            left: 20,
            right: 20,
            ...
            child: Center(
              child: GestureDetector(
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text("ဓာတ်ပုံဂယ်လာရီ ဖွင့်နေသည်..."),
                      duration: Duration(seconds: 1),
                    ),
                  );
                },
