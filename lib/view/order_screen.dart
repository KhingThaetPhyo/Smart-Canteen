...
// // // import 'package:smartcanteen/service/secure_storage_service.dart'; // Import secure storage
...
// // //   // API မှလာသော String status ကို enum သို့ ပြောင်းပေးရန်
...
// // //           : !_isLoggedIn
// // //               // Show only text when user is not logged in
// // //               ? const Center(
// // //                   child: Padding(
// // //                     padding: EdgeInsets.all(24.0),
// // //                     child: Text(
// // //                       "မှာယူမှုမှတ်တမ်းများကိုကြည့်ရှုရန် ကျေးဇူးပြု၍ အကောင့်ဝင်ပါ။",
...
// // //                               matchesStatus = orderStatus == OrderStatus.pending;
...
// //   // Method to fetch orders based on current selected date filter
// //   Future<void> _checkLoginStatusAndLoadOrders() async {
// //     final token = await SecureStorageService.getToken();
// //     _isLoggedIn = token != null && token.isNotEmpty;

// //     if (_isLoggedIn) {
// //       // Map DateFilter enum to API query strings
// //       String? apiFilterParam;
// //       if (_selectedDateFilter == DateFilter.Today) {
// //         apiFilterParam = 'Today';
// //       }
      
// //       // Pass the filter parameter to your API service
...
// //   // Call this whenever the user changes the filter option in the modal sheet
// //   void _onDateFilterChanged(DateFilter filter) {
// //     setState(() {
// //       _selectedDateFilter = filter;
// //       _isLoading = true; // Show loading while fetching filtered data
// //     });
    
// //     // Fetch new orders with the updated filter
// //     _checkLoginStatusAndLoadOrders();
// //   }
// //   OrderStatus _parseStatus(String status) {
// //     switch (status.toLowerCase()) {
...
// //   // Check if the order time string explicitly contains "Today" or "ယနေ့"
// //   final lowerStr = dateStr.toLowerCase();
// //   if (lowerStr.contains('today') || lowerStr.contains('ယနေ့')) {
// //     return true;
// //   }

// //   // Otherwise, fallback to parsing standard date formats (e.g., YYYY-MM-DD)
...
// //                             // 2. Date Filter check ('today' vs 'allTime')
// //                             if (_selectedDateFilter == DateFilter.Today) {
// //                               if (!_isToday(order.orderTime)) {
// //                                 return false;
// //                               }
// //                             }
// //                             // Add handling for thisWeek / thisMonth if required, otherwise allTime passes automatically
