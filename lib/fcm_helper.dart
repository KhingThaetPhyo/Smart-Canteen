...
//   static final Dio _dio = Dio(); // Dio instance

//   /// 1. FCM Token ရယူခြင်းနှင့် Notification Permission တောင်းခံခြင်း
//   static Future<String?> getToken() async {
//     try {
//       // Permission တောင်းခံခြင်း (iOS & Android 13+)
...
//       // Token ပြောင်းလဲသွားတိုင်း Auto Update ပို့ပေးနိုင်ရန် Listen လုပ်ခြင်း
...
//   /// 2. Token ပြောင်းလဲသွားပါက Auto Refresh လုပ်ပေးခြင်း
...
//   /// 3. Dio ကို အသုံးပြု၍ FCM Token ကို သင့် Laravel Backend API သို့ ပို့ပေးမည့် Function
...
//         return true;
//       } else {
//         log("❌ Failed to update FCM Token. Status Code: ${response.statusCode}");
//         return false;
//       }
