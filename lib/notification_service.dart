...
//     // 2. Local Notification Setup
// // 4. Foreground Message Handler (App ပွင့်နေချိန် Noti ပြရန်)
// FirebaseMessaging.onMessage.listen((RemoteMessage message) {
//   RemoteNotification? notification = message.notification;

//   if (notification != null) {
//     // 💡 ID အတွက် hashCode အစား Unique ID တစ်ခု (သို့မဟုတ် DateTime.now) သုံးပေးပါ
...
import 'package:smartcanteen/view/notification_screen.dart'; // Adjust import path
...
await _localNoti.initialize(settings: initializationSettings);
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      if (notification != null) {
        ...
        if (context != null) {
          final String notificationType = message.data['type']?.toString().toLowerCase() ?? '';
